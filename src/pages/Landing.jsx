...
const STEPS = [
  { n: 1, title: "تنشر البلاغ", body: "نموذج واحد: صورة، فئة، مكان، تاريخ." },
  {
    n: 2,
    title: "النظام يطابق",
    body: "مقارنة الفئة والمكان والتاريخ والوصف.",
  },
...
const FIGURES = [
  ...
  {
    value: formatPercent(68),
    label: "من البلاغات وصلت إلى أصحابها",
    accent: true,
  },
    ...
    <ScreenShell>
      <section className="landing-hero">
        ...
        <h1 className="landing-title">
          غرضك المفقود لم يخرج من الحرم الجامعي.
        </h1>
        <div className="landing-lead-col">
          <p className="landing-lead">
            سجّل ما فقدته أو ما وجدته في دقائق. النظام يطابق البلاغات تلقائيًا،
            ويُشعر الطرفين، ويفتح محادثة داخلية دون كشف أرقام التواصل.
          </p>
        ...
        {FIGURES.map((figure) => (
          <div key={figure.label} className="landing-figure">
            <div
              ...
              style={
                figure.accent ? { color: "var(--color-accent-700)" } : undefined
              }
            >
              {figure.value}
            </div>
      ...
      <section className="landing-privacy">
        <div>
          <h2 className="landing-privacy-title">الخصوصية</h2>
          <p className="landing-privacy-body">
            كل التواصل يجري داخل التطبيق. أنت من يقرّر متى تبدأ المحادثة ومتى
            تُغلق البلاغ， ولا يصل أحد إليك خارجه.
          </p>
